...
export const Storybook = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g transform="matrix(2 0 0 2 -4322 -506)">
      ...
      <g clipPath="url(#a)">
        <use xlinkHref="#b" transform="translate(2166 275)" fill="#B57EE5" />
        <use xlinkHref="#c" transform="translate(2180 261)" fill="#F1618C" />
        <use xlinkHref="#d" transform="translate(2326 261.5)" fill="#FFF" />
        <g transform="translate(2393 300)">
          <use xlinkHref="#e" fill="#6DABF5" />
          <use xlinkHref="#f" fill="#F3AD38" />
          <use xlinkHref="#g" fill="#B57EE6" />
          <use xlinkHref="#h" fill="#F16161" />
          <use xlinkHref="#i" fill="#B57EE5" />
          <use xlinkHref="#j" fill="#A2E05E" />
        </g>
        <use xlinkHref="#k" transform="translate(2220 301)" fill="#FFF" />
      </g>
    </g>
    <defs>
